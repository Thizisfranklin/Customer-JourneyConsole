...
This project is my way of combining those ideas: I built a product analytics and user behavior dashboard to model activation, engagement, funnels, retention, and churn. Instead of just optimizing accuracy, I wanted to practice thinking in of real product metrics that data teams care about. Metrics I used for this were DAU/WAU, conversion, and churn risk.
